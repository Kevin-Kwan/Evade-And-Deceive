...
public class LobbySelectMenuScriptMore : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public MenuController whatface;
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.DownArrow) || Input.GetKeyDown(KeyCode.RightArrow) || Input.GetAxisRaw("VerticalPad") > 0 && axisInUse == false || Input.GetAxisRaw("Horizontal") < 0 && horizaxisInUse == false)
        { //Input telling it to go up or down.
            ...
            switch (selectedOption) //Set the visual indicator for which option you are on.
            {
                ...
                case 2:
                    ...
                    pointer.transform.position = new Vector3(option2.transform.position.x, 0); volumeSelected = false;
                    break;
                case 3:
                    option3.color = Color.red;
                    pointer.transform.position = new Vector3(option3.transform.position.x, 0); volumeSelected = false;
                    break;
                case 4:
                    pointer.transform.position = new Vector3(option4.transform.position.x, 0); volumeSelected = false;
                    break;
                case 5:
                    pointer.transform.position = new Vector3(option5.transform.position.x, 0); volumeSelected = false;
                    break;
            }
        ...
        if (Input.GetKeyDown(KeyCode.UpArrow) || Input.GetKeyDown(KeyCode.LeftArrow) || Input.GetAxisRaw("VerticalPad") < 0 && axisInUse == false || Input.GetAxisRaw("Horizontal") > 0 && horizaxisInUse == false)
        { //Input telling it to go up or down.
            axisInUse = true;
            horizaxisInUse = true;
            selectedOption -= 1;
