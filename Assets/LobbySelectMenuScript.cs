...
public class LobbySelectMenuScript : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.DownArrow) || Input.GetKeyDown(KeyCode.LeftArrow) || Input.GetAxisRaw("VerticalPad") > 0 && axisInUse == false || Input.GetAxisRaw("Horizontal") < 0 && horizaxisInUse == false)
        ...
        if (Input.GetKeyDown(KeyCode.UpArrow) || Input.GetKeyDown(KeyCode.RightArrow)  || Input.GetAxisRaw("VerticalPad") < 0 && axisInUse == false || Input.GetAxisRaw("Horizontal") > 0 && horizaxisInUse == false)
        { //Input telling it to go up or down.
            axisInUse = true;
            horizaxisInUse = true;
            selectedOption -= 1;
        ...
        if (Input.GetKeyDown(KeyCode.Return) || Input.GetKeyDown("joystick button 1"))
        {
            ...
            {
                case 1:
                    whatface.SetUserName();
                    break;
                case 2:
                    whatface.ClearUserName();
                    break;
